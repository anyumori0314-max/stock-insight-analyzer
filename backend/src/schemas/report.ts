...
/**
 * zod schema for the public `StockReport` contract. Used to assert (in tests,
 * and available to any consumer) that what we serialize is exactly the
 * documented shape, with every numeric field finite — never NaN/Infinity that
